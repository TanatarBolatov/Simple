    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="mt-4 px-4 mb-8">
        <motion.div 
            ...
            className="w-full h-48 rounded-2xl bg-gray-200 overflow-hidden relative shadow-lg group"
        >
            <img src="https://picsum.photos/800/400?random=99" alt="Banner" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                <span className="bg-brand-yellow text-brand-dark text-xs font-bold px-2 py-1 rounded w-max mb-2">Новинка</span>
                <h2 className="text-white font-display text-2xl">Сезонное меню</h2>
                <p className="text-white/80 text-sm">Попробуйте наши летние новинки</p>
            </div>
        </motion.div>
      </div>
